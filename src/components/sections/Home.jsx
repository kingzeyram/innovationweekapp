...
export const Home = () => {
    ...
    useEffect(() => {
        const preloadImages = () => {
            ...
            if (totalImages === 0) { // Handle case with no images
            ...
            backgroundImages.forEach((imageSrc) => {
                ...
                img.onerror = (error) => {
                    ...
                    // Decide if you want to proceed even if one image fails
                    loadedCount++;
                    if (loadedCount === totalImages) {
                        setImagesLoaded(true);
                    }
                        ...
                        <div className="absolute inset-0">
                            ...
                            <div
                                className={`absolute inset-0 bg-cover bg-center transition-opacity duration-[2000ms] ease-in-out
                                    will-change-opacity will-change-transform transform translate-z-0 backface-hidden
